...
- Title: Add optional OpenAI-backed fallback routing for ambiguous or no-match skill-router subtasks while keeping deterministic fake fallback for tests
- Slug: add-optional-openai-backed-fallback-routing-for-ambiguous-or-no-match-skill-rout
- Branch: unavailable

## Spec Files

- Proposal: openspec/changes/add-optional-openai-backed-fallback-routing-for-ambiguous-or-no-match-skill-rout/proposal.md
- Tasks: openspec/changes/add-optional-openai-backed-fallback-routing-for-ambiguous-or-no-match-skill-rout/tasks.md
...
- Evidence file: .agent/evidence/add-optional-openai-backed-fallback-routing-for-ambiguous-or-no-match-skill-rout.md
...
- .gsd/reports/add-optional-openai-backed-fallback-routing-for-ambiguous-or-no-match-skill-rout.md
